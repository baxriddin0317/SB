    ...
    <div className='w-full'>
      ...
      <div className="mx-auto max-w-[1240px] p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <Link href="https://food-xoja.netlify.app">
          <a target="_blank">
              <button className="px-8 py-2 mt-4 mr-8">Demo</button>
            </a>
          </Link>
          <Link href="https://github.com/baxriddin0317/Food">
          <a target="_blank">
        ...
        <div className="col-span-4 md:col-span-1 shadow-xl shadow-gray-400 rounded-xl p-4">
          <div className="p-2">
            ...
            <div className="grid grid-cols-3 md:grid-cols-1">
                ...
                <p className="text-gray-600 flex items-center"><RiRadioButtonFill className="pr-1" /> Javascript ES6</p>
                <p className="text-gray-600 flex items-center"><RiRadioButtonFill className="pr-1" /> SCSS</p>
                <p className="text-gray-600 flex items-center"><RiRadioButtonFill className="pr-1" /> HTML5</p>
            </div>
          </div>
        </div>

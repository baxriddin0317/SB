...
import FurnikingImg from "../public/Assets/furniking.jpg"
    ...
    <div className='w-full'>
      <div className="w-screen h-[40vh] lg:h-[50vh] relative">
        ...
        <Image 
          ...
          layout="fill" 
          objectFit="cover" 
          src={FurnikingImg} alt='/' 
        />
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
          <h2 className="py-2"> Furniking </h2>
          <h3>Javascript ES6 / HTML5 / CSS3</h3>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-[1240px] p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <Link href="https://furniking-xoja.netlify.app/">
          <a target="_blank">
              <button className="px-8 py-2 mt-4 mr-8">Demo</button>
            </a>
          </Link>
          <Link href="https://github.com/baxriddin0317/furniking">
          <a target="_blank">

...
function ProjectItem({project, i}) {
  console.log(i);
  return (
    <div data-aos={i%2 === 0 ? 'zoom-in-right' : 'zoom-in-left'} className='relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400 rounded-xl p-4 group hover:bg-gradient-to-r from-brand-main to-brand-blue'>
